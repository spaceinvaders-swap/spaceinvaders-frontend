...
import { Flex, Box, useMatchBreakpoints, PageSection } from '@offsideswap/uikit'
...
import MoDRotorBunny from './pngs/MoD-rotor.png'
...
const MoDCompetition = () => {
  ...
  const { hasUserClaimed, isUserActive, userRotoRewards, userDarRewards, userPointReward, canClaimNFT } =
  ...
  const userCanClaimPrizes =
    ...
    isUserActive &&
    !hasUserClaimed &&
    (userRotoRewards !== '0' || userDarRewards !== '0' || userPointReward !== '0' || canClaimNFT)
    ...
    const fetchUserContract = async () => {
      try {
        ...
        const userObject: UserTradingInformation = {
          ...
          userRotoRewards: user[4].toString(),
          ...
          >
            <Box my="64px">
              <TeamRanksWithParticipants
                ...
                subgraphName="offsideswap/trading-competition-v4"
              />
            </Box>
          </PageSection>
        )}
