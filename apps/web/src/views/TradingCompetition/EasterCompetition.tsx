...
import EasterRotorBunny from './pngs/easter-rotors.png'
...
const EasterCompetition = () => {
  ...
  const { hasUserClaimed, userRotoRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userRotoRewards !== '0' || userPointReward !== '0' || canClaimNFT)
