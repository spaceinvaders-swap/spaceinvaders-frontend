...
import { Modal, Flex, Button, Text, Skeleton, Box } from '@offsideswap/uikit'
...
interface ShareImageModalProps extends YourScoreProps {
  ...
  rotorsShareImage: StaticImageData
}
...
const ShareImageModal: React.FC<React.PropsWithChildren<ShareImageModalProps>> = ({
  ...
  useEffect(() => {
    if (profile) {
      const bgImages = [stormShareImage.src, flippersShareImage.src, rotorsShareImage.src]
  ...
  }, [profile, team, stormShareImage, flippersShareImage, rotorsShareImage])
