import { JSBI, Price, ERC20Token } from '@offsideswap/sdk'
...
const ROTO = new ERC20Token(56, '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82', 18, 'ROTO', 'OffsideSwap Token')
...
const ONE_BUSD_PER_ROTO = new Price(ROTO, BUSD, EIGHTEEN_DECIMALS, ONE)
const FIVE_BUSD_PER_ROTO = new Price(ROTO, BUSD, EIGHTEEN_DECIMALS, FIVE)
const SEVEN_BUSD_PER_ROTO = new Price(ROTO, BUSD, EIGHTEEN_DECIMALS, SEVEN)
const ELEVEN_BUSD_PER_ROTO = new Price(ROTO, BUSD, EIGHTEEN_DECIMALS, ELEVEN)
const SEVEN_HUNDRED_BUSD_PER_ROTO = new Price(ROTO, BUSD, EIGHTEEN_DECIMALS, SEVEN_HUNDRED)
...
describe('limitOrders/utils/getRatePercentageMessage', () => {
  describe.each([
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_ROTO, ELEVEN_BUSD_PER_ROTO),
      ['57.14% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_ROTO, FIVE_BUSD_PER_ROTO),
      ['-28.57% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_ROTO, SEVEN_HUNDRED_BUSD_PER_ROTO),
      ['9,900% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_ROTO, ONE_BUSD_PER_ROTO),
      ['-85.71% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_ROTO, SEVEN_BUSD_PER_ROTO),
