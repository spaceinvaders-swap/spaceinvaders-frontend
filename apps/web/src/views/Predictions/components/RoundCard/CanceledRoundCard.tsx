import { Card, CardBody, Text, Flex, BlockIcon, LinkExternal } from '@spaceinvaders-swap/uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.spaceinvaders-swap.finance/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
