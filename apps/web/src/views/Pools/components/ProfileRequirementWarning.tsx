import { Box, Message, MessageText, NextLinkFromReactRouter, Pool } from '@spaceinvaders-swap/uikit'
    ...
    <Message variant="warning">
      <Box>
        <MessageText>
          {notMeetRequired &&
            notMeetThreshold &&
            t('This pool requires active Spaceinvaders Profile and %amount% profile points.', {
              amount: profileRequirement.thresholdPoints.toNumber().toLocaleString(),
            })}
          {notMeetRequired && !notMeetThreshold && t('This pool requires active Spaceinvaders Profile')}
          {!notMeetRequired &&
            notMeetThreshold &&
