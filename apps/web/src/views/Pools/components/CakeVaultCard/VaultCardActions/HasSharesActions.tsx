import { Flex, Text, IconButton, AddIcon, MinusIcon, useModal, Skeleton, Box, Balance, Pool } from '@spaceinvaders-swap/uikit'
...
const HasSharesActions: React.FC<React.PropsWithChildren<HasStakeActionProps>> = ({
  ...
  const stakedDollarValue = invaPriceBusd.gt(0)
    ? getBalanceNumber(invaAsBigNumber.multipliedBy(invaPriceBusd), stakingToken.decimals)
    : 0
  ...
  const [onPresentUnstake] = useModal(
    <VaultStakeModal stakingMax={invaAsBigNumber} pool={pool} isRemovingStake />,
    true,
    true,
    ...
    <>
      <Flex mb="16px" justifyContent="space-between" alignItems="center">
        <Flex flexDirection="column">
          <Balance fontSize="20px" bold value={invaAsNumberBalance} decimals={5} />
