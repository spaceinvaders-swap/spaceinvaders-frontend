...
import { Button, useModal, Skeleton } from '@spaceinvaders-swap/uikit'
...
const AddInvaButton: React.FC<React.PropsWithChildren<AddButtonProps>> = ({
  currentBalance,
  stakingToken,
  currentLockedAmount,
  lockEndTime,
...
export default memo(AddInvaButton)
