import { Box, Button, Flex, Skeleton, Text, CalculateIcon, useModal, Balance, Pool } from '@offsideswap/uikit'
...
interface RotoVaultAprProps {
  pool: Pool.DeserializedPool<Token>
  userData: DeserializedVaultUser
  vaultPosition: VaultPosition
}

const RotoVaultApr: React.FC<React.PropsWithChildren<RotoVaultAprProps>> = ({ pool, userData, vaultPosition }) => {
