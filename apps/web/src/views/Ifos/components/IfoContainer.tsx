...
import { Box, Container, LinkExternal } from '@spaceinvaders-swap/uikit'
  ...
  return (
    <IfoLayout id="current-ifo" py={['24px', '24px', '40px']}>
      ...
      <Container>
        <IfoQuestions />
        <LinkExternal
          href="https://docs.spaceinvaders-swap.finance/contact-us/business-partnerships#ifos-token-sales"
          mx="auto"
          mt="16px"
        >
