...
const BoosterTooltip = () => {
  ...
  return (
    <>
      {t(
        `Boost multiplier is calculated based on the staking conditions from both Farms and fixed-term ROTO syrup pool and will be automatically updated upon user actions.`,
      )}
      <LinkExternal
        href="https://docs.offsideswap.finance/products/yield-farming/broto/faq#how-are-the-broto-multipliers-calculated"
        external
      >
        {t('Learn More')}
      </LinkExternal>
