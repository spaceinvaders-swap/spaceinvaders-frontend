...
import { AutoRenewIcon, Button, ButtonProps, useToast } from '@offsideswap/uikit'
import { ToastDescriptionWithTx } from 'components/Toast'
import useCatchTxError from 'hooks/useCatchTxError'
import { useBRotoFarmBoosterProxyFactoryContract } from 'hooks/useContract'
...
const CreateProxyButton: React.FC<React.PropsWithChildren<CreateProxyButtonProps>> = ({ onDone, ...props }) => {
  ...
  const farmBoosterProxyFactoryContract = useBRotoFarmBoosterProxyFactoryContract()
