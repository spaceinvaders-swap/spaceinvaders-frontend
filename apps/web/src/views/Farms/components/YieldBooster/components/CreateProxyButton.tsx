...
import { AutoRenewIcon, Button, ButtonProps, useToast } from '@spaceinvaders-swap/uikit'
import { ToastDescriptionWithTx } from 'components/Toast'
import useCatchTxError from 'hooks/useCatchTxError'
import { useBInvaFarmBoosterProxyFactoryContract } from 'hooks/useContract'
...
const CreateProxyButton: React.FC<React.PropsWithChildren<CreateProxyButtonProps>> = ({ onDone, ...props }) => {
  ...
  const farmBoosterProxyFactoryContract = useBInvaFarmBoosterProxyFactoryContract()
