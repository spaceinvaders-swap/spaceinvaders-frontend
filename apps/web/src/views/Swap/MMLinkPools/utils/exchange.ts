import { Currency, CurrencyAmount, Fraction, JSBI, Percent, Price, TradeType, ZERO_PERCENT } from '@spaceinvaders-swap/sdk'

import { parseUnits } from '@ethersproject/units'
import SpaceinvadersSwapMMLinkedPoolABI from 'config/abi/mmLinkedPool.json'
...
export function useMMSwapContract() {
  ...
  return useContract<MmLinkedPool>(MM_SWAP_CONTRACT_ADDRESS[chainId], SpaceinvadersSwapMMLinkedPoolABI, true)
}
