import { Currency, CurrencyAmount, Pair, TradeType } from '@spaceinvaders-swap/sdk'
import { StableSwapPair, TradeWithStableSwap } from '@spaceinvaders-swap/smart-router/evm'
import { Field } from 'state/swap/actions'
import { useCurrencyBalances } from 'state/wallet/hooks'
import { useTranslation } from '@spaceinvaders-swap/localization'
import tryParseAmount from '@spaceinvaders-swap/utils/tryParseAmount'
import { useWeb3React } from '@spaceinvaders-swap/wagmi'
