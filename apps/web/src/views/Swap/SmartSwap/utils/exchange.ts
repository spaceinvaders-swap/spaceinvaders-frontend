import { Currency, CurrencyAmount, Fraction, JSBI, Percent, TradeType, ChainId } from '@spaceinvaders-swap/sdk'
import { TradeWithStableSwap, Trade, isStableSwapPair } from '@spaceinvaders-swap/smart-router/evm'

import { BIPS_BASE, INPUT_FRACTION_AFTER_FEE, ONE_HUNDRED_PERCENT } from 'config/constants/exchange'
import { Field } from 'state/swap/actions'
import { basisPointsToPercent } from 'utils/exchange'
import SpaceinvadersSwapSmartRouterABI from 'config/abi/spaceinvadersSwapSmartRouter.json'
import { SpaceinvadersSwapSmartRouter } from 'config/abi/types/SpaceinvadersSwapSmartRouter'
...
export function useSmartRouterContract() {
  ...
  return useContract<SpaceinvadersSwapSmartRouter>(SMART_ROUTER_ADDRESS[chainId], SpaceinvadersSwapSmartRouterABI, true)
}
