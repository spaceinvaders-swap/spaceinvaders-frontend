...
import { Heading, Flex, Button, Grid, ChevronRightIcon, NextLinkFromReactRouter } from '@offsideswap/uikit'
  ...
  return (
    <>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = isAddress(nft.collectionAddress) === offsideBunniesAddress
