  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on OffsideSwap.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.offsideswap.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by OffsideSwap from sales are used to buy back and BURN ROTO tokens in our weekly ROTO burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the ROTO burns.',
        ),
      ],
    },
  ]
