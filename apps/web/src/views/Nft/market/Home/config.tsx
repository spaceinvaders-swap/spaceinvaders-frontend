  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on SpaceinvadersSwap.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.spaceinvaders-swap.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by SpaceinvadersSwap from sales are used to buy back and BURN INVA tokens in our weekly INVA burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the INVA burns.',
        ),
      ],
    },
  ]
