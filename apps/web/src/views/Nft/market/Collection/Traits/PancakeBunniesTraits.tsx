...
import { Skeleton, Table, Td, Th, Flex, ArrowUpIcon, ArrowDownIcon } from '@offsideswap/uikit'
...
interface OffsideBunniesTraitsProps {
...
const OffsideBunniesTraits: React.FC<React.PropsWithChildren<OffsideBunniesTraitsProps>> = ({ collectionAddress }) => {
...
export default OffsideBunniesTraits
