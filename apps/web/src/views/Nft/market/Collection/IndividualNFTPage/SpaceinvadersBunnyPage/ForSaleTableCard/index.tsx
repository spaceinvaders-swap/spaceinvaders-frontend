...
import { useSpaceinvadersBunnyOnSaleNfts } from '../../../../hooks/useSpaceinvadersBunnyOnSaleNfts'
...
const ForSaleTableCard: React.FC<React.PropsWithChildren<ForSaleTableCardProps>> = ({
  ...
  const {
    ...
    isLastPage,
    isValidating,
  } = useSpaceinvadersBunnyOnSaleNfts(bunnyId, nftMetadata, itemsPerPage * 10)
  ...
  return (
    <StyledCard hasManyPages>
      ...
      >
        ...
        <UpdateIndicator isFetchingSpaceinvadersBunnies={isValidating} />
      </Grid>
