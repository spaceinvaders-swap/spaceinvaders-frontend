...
import { Modal, Text, Box, Flex, BalanceInput } from '@spaceinvaders-swap/uikit'
...
const WinRateModal: React.FC<React.PropsWithChildren<WinRateModalProps>> = ({
  ...
  const {
    ...
    setCalculatorMode,
    setTargetWinRate,
  } = useWinRateCalculator({ invaPrice, totalSupply })
  ...
  const editingUnit = editingCurrency === EditingCurrency.TOKEN ? 'INVA' : 'USD'
  const editingValue = editingCurrency === EditingCurrency.TOKEN ? principalAsToken : principalAsUSD
  const conversionUnit = editingCurrency === EditingCurrency.TOKEN ? 'USD' : 'INVA'
