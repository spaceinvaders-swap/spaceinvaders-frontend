...
import { Flex, Box, Card, Text, useMatchBreakpoints, Balance, ButtonTabMenu } from '@spaceinvaders-swap/uikit'
...
const Pot: React.FC<React.PropsWithChildren> = () => {
  ...
  const prizeInBusd = publicData.totalPrize.times(invaPriceBusd)
          ...
          <Flex mt="48px" alignItems="flex-start">
            <Card style={{ width: isMobile ? '100%' : '436px' }}>
              ...
              <Box>
                <CardHeader
                  title={t('Pottery')}
                  subTitle={t('Stake INVA, Earn INVA, Win INVA')}
