...
import { Box, Flex, Text, CardBody, CardRibbon, LinkExternal, Skeleton, Balance } from '@spaceinvaders-swap/uikit'
...
const PreviousRoundCardBody: React.FC<React.PropsWithChildren<PreviousRoundCardBodyProps>> = ({
  ...
  const prizeInBusd = new BigNumber(prize).times(invaPriceBusd).toNumber()
