...
import { Currency, Fraction, Percent, CurrencyAmount, Token } from '@offsideswap/sdk'
import { Text, useTooltip, TooltipText, Box, Flex, Svg, SvgProps, AutoColumn } from '@offsideswap/uikit'
