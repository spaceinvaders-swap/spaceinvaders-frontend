...
const HarvestCard = () => {
  ...
  const earningsBusd = new BigNumber(farmEarningsSum).multipliedBy(invaPriceBusd)
  ...
  const hasInvaPoolToCollect = numTotalToCollect - numFarmsToCollect > 0

  const earningsText = getEarningsText(numFarmsToCollect, hasInvaPoolToCollect, earningsBusd, t)
