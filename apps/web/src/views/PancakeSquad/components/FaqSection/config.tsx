...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Offside Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Offside Bunny NFTs at the snapshot may also purchase one additional Offside Squad NFT in the presale for each Offside Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of ROTO spent on Offside Squad NFTs will be burned as part of our weekly ROTO burn.')],
  },
  {
