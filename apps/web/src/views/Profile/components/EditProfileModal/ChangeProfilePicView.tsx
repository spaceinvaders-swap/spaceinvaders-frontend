...
import { Box, Button, InjectedModalProps, Skeleton, Text, useToast } from '@spaceinvaders-swap/uikit'
    ...
    <>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Make sure you have a Spaceinvaders Collectible in your wallet and try again!')}
          </Text>
        </>
      )}
