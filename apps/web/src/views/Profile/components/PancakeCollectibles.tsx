import { Grid, Heading, PageHeader } from '@spaceinvaders-swap/uikit'
...
const SpaceinvadersCollectibles = () => {
  const { t } = useTranslation()
  const { data: collections, status } = useSWR<Collection[]>(['spaceinvadersCollectibles'])

  return (
    <>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="secondary" data-test="nft-collections-title">
          {t('Spaceinvaders Collectibles')}
        </Heading>
      </PageHeader>
      <Page>
...
export default SpaceinvadersCollectibles
