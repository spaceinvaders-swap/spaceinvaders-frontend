...
const PoolRow: React.FC<React.PropsWithChildren<PoolRowProps>> = ({ pool, account }) => {
  ...
  const { totalRotoInVault } = useVaultPoolByKey(pool.vaultKey)
  ...
  return (
    <>
      <StyledRow role="row" onClick={toggleExpanded}>
        ...
        {isLargerScreen && <TotalStakedCell pool={pool} totalRotoInVault={totalRotoInVault} rotoInVaults={BIG_ZERO} />}
