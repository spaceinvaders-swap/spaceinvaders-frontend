...
import { Flex, Heading, Text, useMatchBreakpoints, Balance } from '@offsideswap/uikit'
import { ActionContainer, ActionContent, ActionTitles } from 'views/Pools/components/PoolsTable/ActionPanel/styles'
import { usePriceRotoBusd } from 'state/farmsV1/hooks'
...
const Earned: React.FC<React.PropsWithChildren<EarnedProps>> = ({ earnings }) => {
  ...
  if (!earningsBigNumber.isZero()) {
    earningsBusd = earningsBigNumber.multipliedBy(rotoPrice).toNumber()
