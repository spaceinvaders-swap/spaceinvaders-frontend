...
import { AutoRenewIcon, Button, useToast, Pool } from '@spaceinvaders-swap/uikit'
...
import { invaVaultAddress, ifoPoolV1Contract, useVaultPoolByKeyV1 } from 'views/Migration/hook/V1/Pool/useFetchIfoPool'
...
const UnstakeButton: React.FC<React.PropsWithChildren<UnstakeButtonProps>> = ({ pool }) => {
  ...
  const vaultPoolContract = useMemo(() => {
    return vaultKey === VaultKey.InvaVaultV1
      ? getContract({ abi: invaVaultAbi, address: invaVaultAddress, signer })
