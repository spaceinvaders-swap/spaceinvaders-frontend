...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Spaceinvaders Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Spaceinvaders Bunny NFTs at the snapshot may also purchase one additional Spaceinvaders Squad NFT in the presale for each Spaceinvaders Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of INVA spent on Spaceinvaders Squad NFTs will be burned as part of our weekly INVA burn.')],
  },
  {
