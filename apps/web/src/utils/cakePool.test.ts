...
import { VaultPosition, getVaultPosition } from './rotoPool'
import { getRotoVaultV2Contract } from './contractHelpers'

describe.concurrent('rotoPool', () => {
  it.each([
    ...
    const rotoVault = getRotoVaultV2Contract()
    const got = await rotoVault[method]()
