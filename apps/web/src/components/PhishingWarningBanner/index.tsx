...
import { Text, Flex, Box, CloseIcon, IconButton, useMatchBreakpoints } from '@offsideswap/uikit'
...
const domain = 'https://offsideswap.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    ...
    return warningText.split(/(https:\/\/offsideswap.finance)/g)
  }, [t])
