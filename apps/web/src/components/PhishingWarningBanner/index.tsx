...
import { Text, Flex, Box, CloseIcon, IconButton, useMatchBreakpoints } from '@spaceinvaders-swap/uikit'
...
const domain = 'https://spaceinvaders-swap.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    ...
    return warningText.split(/(https:\/\/spaceinvaders-swap.finance)/g)
  }, [t])
