...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@offsideswap/uikit'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.offsideswap.finance/get-started/connection-guide" external>
