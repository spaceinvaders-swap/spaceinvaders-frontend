...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@spaceinvaders-swap/uikit'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.spaceinvaders-swap.finance/get-started/connection-guide" external>
