...
import { getAltText, getEventStepStatus, getEventText } from 'views/SpaceinvadersSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('SpaceinvadersSquad/utils/getEventStepStatus', () => {
...
describe('SpaceinvadersSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('SpaceinvadersSquad/utils/getAltText', () => {
