import { BuyButtonsEnum } from 'views/SpaceinvadersSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/SpaceinvadersSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/SpaceinvadersSquad/types'

describe('SpaceinvadersSquad/buttons/utils/getBuyButtonText', () => {
...
describe('SpaceinvadersSquad/buttons/utils/getBuyButton', () => {
