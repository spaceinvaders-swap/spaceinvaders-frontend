import { ChainId, Pair, ERC20Token } from '@spaceinvaders-swap/sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [ERC20Token, ERC20Token]): ERC20Token {
  return new ERC20Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Inva-LP', 'Spaceinvaders LPs')
}
