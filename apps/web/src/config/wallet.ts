import { WalletConfigV2 } from '@spaceinvaders-swap/ui-wallets'
import { WalletFilledIcon } from '@spaceinvaders-swap/uikit'
import type { ExtendEthereum } from 'global'
import { isFirefox } from 'react-device-detect'
import WalletConnectProvider from '@walletconnect/ethereum-provider'
import { getTrustWalletProvider } from '@spaceinvaders-swap/wagmi/connectors/trustWallet'
  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/spaceinvaders-swap.finance/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/spaceinvaders-swap.finance/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://spaceinvaders-swap.finance/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.spaceinvaders-swap.finance/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.spaceinvaders-swap.finance/get-started/wallet-guide`
