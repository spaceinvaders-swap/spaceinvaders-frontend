...
export const EXCHANGE_DOCS_URLS = 'https://docs.spaceinvaders-swap.finance/products/spaceinvaders-swap-exchange'
export const EXCHANGE_HELP_URLS = 'https://docs.spaceinvaders-swap.finance/help'
