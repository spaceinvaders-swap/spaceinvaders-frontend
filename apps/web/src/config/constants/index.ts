...
export const EXCHANGE_DOCS_URLS = 'https://docs.offsideswap.finance/products/offsideswap-exchange'
export const EXCHANGE_HELP_URLS = 'https://docs.offsideswap.finance/help'
