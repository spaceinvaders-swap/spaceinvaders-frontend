import { ChainId, JSBI, Percent, Token, WNATIVE } from '@offsideswap/sdk'
import { BigNumber } from '@ethersproject/bignumber'
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH } from '@offsideswap/tokens'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.roto, bscTestnetTokens.busd],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.usdt, bscTokens.roto, bscTokens.btcb],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.roto, bscTestnetTokens.busd],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.BSC]: [bscTokens.wbnb, bscTokens.dai, bscTokens.busd, bscTokens.usdt, bscTokens.roto],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.roto, bscTestnetTokens.busd],
}
...
export const GELATO_HANDLER = 'offsideswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.offsideswap.finance/products/offsideswap-exchange/limit-orders'
