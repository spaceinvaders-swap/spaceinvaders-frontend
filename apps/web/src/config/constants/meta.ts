...
export const DEFAULT_META: PageMeta = {
  title: 'SpaceinvadersSwap',
  description:
    'The most popular AMM on BSC by user count! Earn INVA through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by SpaceinvadersSwap), NFTs, and more, on a platform you can trust.',
  ...
  return {
    paths: {
      ...
      '/info': {
        ...
        description: 'View statistics for Spaceinvadersswap exchanges.',
      ...
      '/spaceinvaders-squad': { basePath: true, title: t('Spaceinvaders Squad') },
      '/pottery': { basePath: true, title: t('Pottery'), image: `${ASSET_CDN}/web/og/pottery.jpg` },
    },
    defaultTitleSuffix: t('SpaceinvadersSwap'),
  }
}
