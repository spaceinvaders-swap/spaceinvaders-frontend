import { Pair, ChainId } from '@spaceinvaders-swap/aptos-swap-sdk'
...
const farms: SerializedFarmConfig[] = [
  ...
  {
    pid: 1,
    lpSymbol: testnetTokens.inva.symbol,
    lpAddress: testnetTokens.inva.address,
    token: testnetTokens.inva,
    quoteToken: testnetTokens.inva,
  },
  {
    pid: 5,
    lpSymbol: 'USDC-INVA LP',
    lpAddress:
      '0xc7efb4076dbe143cbcd98cfaaa929ecfc8f299203dfff63b95ccb6bfe19850fa::swap::LPToken<0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetUSDC, 0xe0e5ad285cbcdb873b2ee15bb6bcac73d9d763bcb58395e894255eeecf3992cf::spaceinvaders::Inva>',
    token: testnetTokens.inva,
    quoteToken: L0_USDC[ChainId.TESTNET],
  },
  {
    pid: 4,
    lpSymbol: 'APT-INVA LP',
    lpAddress:
      '0xc7efb4076dbe143cbcd98cfaaa929ecfc8f299203dfff63b95ccb6bfe19850fa::swap::LPToken<0x1::aptos_coin::AptosCoin, 0xe0e5ad285cbcdb873b2ee15bb6bcac73d9d763bcb58395e894255eeecf3992cf::spaceinvaders::Inva>',
    token: testnetTokens.inva,
