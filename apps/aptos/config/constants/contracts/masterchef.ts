...
export type MasterchefUpdateRotoRateArgs = [bigint | string, bigint | string, boolean]

export const masterchefUpdateRotoRate = (
  args: MasterchefUpdateRotoRateArgs,
): Types.TransactionPayload_EntryFunctionPayload => {
  return {
    type: 'entry_function_payload',
    type_arguments: [],
    arguments: args,
    function: `${ADDRESS}::${MASTERCHEF_MODULE_NAME}::update_roto_rate`,
  }
}
