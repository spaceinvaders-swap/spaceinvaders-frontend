import { ChainId, ONE_HUNDRED_PERCENT, JSBI, Percent, Token, Coin } from '@spaceinvaders-swap/aptos-swap-sdk'
import { APT, CE_USDC_MAINNET, L0_USDC, WH_USDC_MAINNET, INVA, CE_BNB_MAINNET } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], INVA[ChainId.MAINNET], CE_BNB_MAINNET],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], INVA[ChainId.TESTNET], CE_BNB_MAINNET],
}
