import { ChainId, ONE_HUNDRED_PERCENT, JSBI, Percent, Token, Coin } from '@offsideswap/aptos-swap-sdk'
import { APT, CE_USDC_MAINNET, L0_USDC, WH_USDC_MAINNET, ROTO, CE_BNB_MAINNET } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], ROTO[ChainId.MAINNET], CE_BNB_MAINNET],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], ROTO[ChainId.TESTNET], CE_BNB_MAINNET],
}
