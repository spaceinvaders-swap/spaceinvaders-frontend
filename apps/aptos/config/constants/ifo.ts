...
export const ifos: Ifo[] = [
  {
    id: 'move',
    address: `${IFO_POOL_STORE_TAG}<${mainnetTokens.roto.address}, ${mainnetTokens.move.address}, ${getIFOUID(1)}>`,
    isActive: true,
    name: 'MOVE',
    poolUnlimited: {
    ...
    campaignId: '1',
    currency: mainnetTokens.roto,
    token: mainnetTokens.move,
    releaseTime: 1675944000,
    articleUrl: 'https://medium.com/offsideswap/bluemove-move-ifo-to-be-hosted-on-aptos-offsideswap-25adee83d1ee',
