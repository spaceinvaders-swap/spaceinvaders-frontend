...
export const ifos: Ifo[] = [
  {
    id: 'move',
    address: `${IFO_POOL_STORE_TAG}<${mainnetTokens.inva.address}, ${mainnetTokens.move.address}, ${getIFOUID(1)}>`,
    isActive: true,
    name: 'MOVE',
    poolUnlimited: {
    ...
    campaignId: '1',
    currency: mainnetTokens.inva,
    token: mainnetTokens.move,
    releaseTime: 1675944000,
    articleUrl: 'https://medium.com/spaceinvaders-swap/bluemove-move-ifo-to-be-hosted-on-aptos-spaceinvaders-swap-25adee83d1ee',
