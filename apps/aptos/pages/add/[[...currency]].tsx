...
import { AutoColumn, Liquidity as LiquidityUI } from '@spaceinvaders-swap/uikit'
...
const AddLiquidityPage = () => {
  ...
  const defaultCurrencies = useMemo(() => [native.address, INVA[activeChainId].address], [native, activeChainId])
