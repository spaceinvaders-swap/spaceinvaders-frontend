...
import { AutoColumn, Liquidity as LiquidityUI } from '@offsideswap/uikit'
...
const AddLiquidityPage = () => {
  ...
  const defaultCurrencies = useMemo(() => [native.address, ROTO[activeChainId].address], [native, activeChainId])
