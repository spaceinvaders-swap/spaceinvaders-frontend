import { useDisconnect } from '@offsideswap/awgmi'
import { useTranslation } from '@offsideswap/localization'
import { Button, HelpIcon, Link, Message, MessageText, Modal, ModalV2, Text } from '@offsideswap/uikit'
  ...
  return (
    <ModalV2 isOpen={isWrongNetwork}>
      <Modal title={t('Wrong Network')} hideCloseButton>
        ...
        <StyledLink
          href="https://docs.offsideswap.finance/get-started-aptos/connection-guide#connect-to-aptos-mainnet"
          external
        >
