import { Pool, useToast } from '@offsideswap/uikit'
...
import { TransactionResponse } from '@offsideswap/awgmi/dist/core'
...
const StakeModalContainer = ({
  ...
  return (
    <Pool.StakeModal
      ...
      imageUrl="https://tokens.offsideswap.finance/images/aptos/"
    />
  )
}
