...
import { Flex, Heading, PageHeader, Pool, Text, FlexLayout, ViewMode } from '@spaceinvaders-swap/uikit'
...
import InvaCardActions from './components/PoolCard/InvaCardActions'
