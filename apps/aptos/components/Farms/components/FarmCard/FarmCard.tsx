...
import { Card, Flex, Text, Skeleton, ExpandableSectionButton, Farm as FarmUI } from '@offsideswap/uikit'
...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('ROTO + Fees')
  ...
  const isPromotedFarm = farm.token?.symbol === 'ROTO'
