import { useNetwork } from '@offsideswap/awgmi'
import { useIsMounted } from '@offsideswap/hooks'
import { useTranslation } from '@offsideswap/localization'
import { Box, Text, UserMenu, UserMenuDivider, UserMenuItem } from '@offsideswap/uikit'
...
export const NetworkSwitcher = () => {
  ...
  return (
    <UserMenu
      mr="8px"
      variant="default"
      avatarSrc="https://tokens.offsideswap.finance/images/symbol/apt.png"
