...
import { languageList, useTranslation } from '@spaceinvaders-swap/localization'
import { Menu as UIMenu, NextLinkFromReactRouter, footerLinks } from '@spaceinvaders-swap/uikit'
...
export const Menu = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <UIMenu
      ...
      langs={languageList}
      invaPriceUsd={invaPrice ? Number(invaPrice) : undefined}
      // @ts-ignore
      subLinks={activeMenuItem?.hideSubNav || activeSubMenuItem?.hideSubNav ? [] : activeMenuItem?.items}
      activeSubItem={activeSubMenuItem?.href}
      toggleTheme={toggleTheme}
      buyInvaLabel={t('Buy INVA')}
      buyInvaLink="https://aptos.spaceinvaders-swap.finance/swap?outputCurrency=0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::InvaOFT"
    >
      {children}
    </UIMenu>
  )
