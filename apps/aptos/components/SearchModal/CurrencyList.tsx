import { Currency, CurrencyAmount, Token } from '@spaceinvaders-swap/aptos-swap-sdk'
import { APTOS_COIN, useAccount, useAccountBalance } from '@spaceinvaders-swap/awgmi'
import { useTranslation } from '@spaceinvaders-swap/localization'
import { CircleLoader, Column, QuestionHelper, RowBetween, RowFixed, Text } from '@spaceinvaders-swap/uikit'
