import { CurrencyAmount, Token } from '@spaceinvaders-swap/sdk'
import {
  BlockIcon,
  Box,
  Button,
...
export function Menu() {
  ...
  return (
    <Flex height="56px" bg="backgroundAlt" px="16px" alignItems="center" justifyContent="space-between" zIndex={9}>
      <Flex>
        <Logo href="https://spaceinvaders-swap.finance" />
        ...
        <Flex pl={['10px', null, '50px']}>
          ...
          <a href="https://spaceinvaders-swap.finance/swap" target="_blank" rel="noreferrer noopener">
