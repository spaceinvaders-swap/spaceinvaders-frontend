import { ChainId, Token, WBNB, WNATIVE } from '@offsideswap/sdk'
import { bscTokens, bscTestnetTokens, BUSD, USDC, USDT } from '@offsideswap/tokens'
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.busd, bscTokens.roto, bscTokens.btcb],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.roto, bscTestnetTokens.busd],
}
