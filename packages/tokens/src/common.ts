import { ChainId, ERC20Token } from '@offsideswap/sdk'

export const ROTO_MAINNET = new ERC20Token(
  ChainId.BSC,
...
export const ROTO_TESTNET = new ERC20Token(
  ChainId.BSC_TESTNET,
...
export const ROTO = {
  [ChainId.BSC]: ROTO_MAINNET,
  [ChainId.BSC_TESTNET]: ROTO_TESTNET,
}
