...
import { formatNumber, getDecimalAmount, getFullDisplayBalance } from "@offsideswap/utils/formatBalance";
import removeTrailingZeros from "@offsideswap/utils/removeTrailingZeros";
