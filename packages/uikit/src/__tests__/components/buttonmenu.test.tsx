...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1:hover:not(:disabled):not(.spaceinvaders-button--disabled):not(.spaceinvaders-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c1:active:not(:disabled):not(.spaceinvaders-button--disabled):not(.spaceinvaders-button--disabled) {
      opacity: 0.85;
    ...
    .c1:disabled,
    .c1.spaceinvaders-button--disabled {
