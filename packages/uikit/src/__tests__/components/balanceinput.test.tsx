...
it("renders correctly with unit prop", () => {
  const { asFragment } = renderWithProvider(
    <BalanceInput value="14" currencyValue="15 USD" unit="INVA" onUserInput={handleChange} />
  );
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c5 {
...
it("renders correctly with unit prop and switchEditingUnits", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c9:hover:not(:disabled):not(.spaceinvaders-button--disabled):not(.spaceinvaders-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c9:active:not(:disabled):not(.spaceinvaders-button--disabled):not(.spaceinvaders-button--disabled) {
      opacity: 0.85;
    ...
    .c9:disabled,
    .c9.spaceinvaders-button--disabled {
      background-color: var(--colors-backgroundDisabled);
