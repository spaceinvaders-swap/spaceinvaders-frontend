...
import {
  ...
  getDefaultProviders,
  defaultChains,
} from '@offsideswap/awgmi';
import { PetraConnector } from '@offsideswap/awgmi/connectors/petra'
import { MartianConnector } from '@offsideswap/awgmi/connectors/martain'
import { SafePalConnector } from '@offsideswap/awgmi/connectors/safePal'
import { BloctoConnector } from '@offsideswap/awgmi/connectors/blocto'
import { FewchaConnector } from '@offsideswap/awgmi/connectors/fewcha'

 // import { mainnet, testnet } from '@offsideswap/awgmi/core'
...
## Connector
```jsx
import { useConnect, useDisconnect } from '@offsideswap/awgmi'
...
### Send Transaction
```js
import { UserRejectedRequestError } from '@offsideswap/awgmi'
