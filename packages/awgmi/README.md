...
import {
  ...
  getDefaultProviders,
  defaultChains,
} from '@spaceinvaders-swap/awgmi';
import { PetraConnector } from '@spaceinvaders-swap/awgmi/connectors/petra'
import { MartianConnector } from '@spaceinvaders-swap/awgmi/connectors/martain'
import { SafePalConnector } from '@spaceinvaders-swap/awgmi/connectors/safePal'
import { BloctoConnector } from '@spaceinvaders-swap/awgmi/connectors/blocto'
import { FewchaConnector } from '@spaceinvaders-swap/awgmi/connectors/fewcha'

 // import { mainnet, testnet } from '@spaceinvaders-swap/awgmi/core'
...
### Send Transaction
```js
import { UserRejectedRequestError } from '@spaceinvaders-swap/awgmi'
