import { Trans } from '@offsideswap/localization'
import { AtomBox } from '@offsideswap/ui/components/AtomBox'
import { Button, Heading, Image, LinkExternal, Text } from '@offsideswap/uikit'
...
const IntroSteps = [
  {
    ...
    icon: 'https://cdn.offsideswap.com/wallets/wallet_intro.png',
    description: (
      <Trans>
  ...
  },
  {
    ...
    icon: 'https://cdn.offsideswap.com/wallets/world_lock.png',
    description: (
      <Trans>
