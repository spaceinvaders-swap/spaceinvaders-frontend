...
import { Call, MultiCallV2 } from '@offsideswap/multicall'
...
const masterChefV2Abi = [
  {
    ...
    name: 'poolInfo',
    outputs: [
      { internalType: 'uint256', name: 'accRotoPerShare', type: 'uint256' },
...
export const fetchMasterChefV2Data = async ({
  ...
  try {
    const [[poolLength], [totalRegularAllocPoint], [totalSpecialAllocPoint], [rotoPerBlock]] = await multicallv2<
