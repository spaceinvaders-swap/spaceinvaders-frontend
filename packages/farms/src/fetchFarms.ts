...
import { Call, MultiCallV2 } from '@spaceinvaders-swap/multicall'
...
const masterChefV2Abi = [
  {
    ...
    name: 'poolInfo',
    outputs: [
      { internalType: 'uint256', name: 'accInvaPerShare', type: 'uint256' },
...
export const fetchMasterChefV2Data = async ({
  ...
  try {
    const [[poolLength], [totalRegularAllocPoint], [totalSpecialAllocPoint], [invaPerBlock]] = await multicallv2<
