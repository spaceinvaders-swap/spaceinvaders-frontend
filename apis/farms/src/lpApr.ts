...
import { AprMap } from '@offsideswap/farms'
...
const STABLESWAP_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/offsideswap/exchange-stableswap'

const LP_HOLDERS_FEE = 0.0017
const WEEKS_IN_A_YEAR = 52.1429

const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://api.thegraph.com/subgraphs/name/offsideswap/blocks',
...
const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://proxy-worker.offside-swap.workers.dev/bsc-exchange',
  [ChainId.ETHEREUM]: 'https://api.thegraph.com/subgraphs/name/offsideswap/exhange-eth',
  [ChainId.BSC_TESTNET]: '',
  [ChainId.GOERLI]: '',
}
